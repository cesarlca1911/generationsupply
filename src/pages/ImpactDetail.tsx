...
const descriptions: Record<string, string> = {
  "gbe-dropbox":
    "Secured and centralized collection of premium academic assets. Our campaign has raised $953.04 worth of these premium assets in merely two weeks after initial launch, which will be redistributed to directly support 300 underprivileged GBE students.",
  "gbe-mailers":
