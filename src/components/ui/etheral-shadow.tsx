  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Mask image from Framer CDN — shapes the ethereal shadow cloud */}
        <div
          style={{
      ...
      {/* Optional noise texture (disabled by default — we use GrainOverlay instead) */}
